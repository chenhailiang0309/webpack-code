...
layui.define(['jquery', 'layer'], function(exports){
	...
	var obj = function(config){
		...
		this.createOption = function(){
            ...
            var html = '<link rel=\"stylesheet\" href=\"./resource/layui/lay/modules/zTreeSelectM/zTreeSelectM.css\">\n';            
	            html += '<link rel=\"stylesheet\" href=\"./resource/layui/lay/modules/zTreeSelectM/zTree_v3/css/zTreeStyle/zTreeStyle.css\">\n';
	            html += '<script type=\"text/javascript\" src=\"./resource/layui/lay/modules/zTreeSelectM/zTree_v3/js/jquery.ztree.all.min.js\"></script>\n';
                ...
                html +=         '<dd lay-value="" class="layui-select-tips">' + '请选择' + '</dd>';
    ...
    obj.prototype.render = function(){
        ...
        $E.on('click', '.layui-select-title,.multiple,.multiple.layui-edge', function (e) {
			...
			if($(c.elem).hasClass('.layui-form-selected')){
